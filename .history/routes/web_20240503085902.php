...
Route::prefix('categories')->group(function ()
{
    ...
    Route::get('/eidt/{id}', [CategoriesController::class, 'getCategory'])->('categories.edit');

    //xử lí update chuyên mục
    Route::post('/edit/{id}', [CategoriesController::class, 'updateCategory']);

    //hiện thị form add dữ liệu
    Route::get('/add', [CategoriesController::class, 'addCategory'])->('categories.add');

    //xử lí thêm chuyên mục
    Route::post('/add', [CategoriesController::class, 'handleAddCategory']);

    //xóa chuyên mục
    Route::delete('/delete/{id}', [CategoriesController::class, 'deleteCategory'])->('categories.delete');
});